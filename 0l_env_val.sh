...
echo ""
sleep 2
sudo apt install -y sudo curl git vim mpstat zip unzip daemontools bc jq build-essential cmake clang llvm libgmp-dev secure-delete pkg-config libssl-dev lld tmux
echo ""
